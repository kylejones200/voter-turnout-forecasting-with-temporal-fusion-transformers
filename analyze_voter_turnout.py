...
def analyze_turnout_patterns(df):
    ...
    presidential_bump = (
        presidential_elections["Turnout_Rate"].mean() - midterm_elections["Turnout_Rate"].mean()
    )
...
def run_analysis(start_year, images_dir, period_name):
    ...
    calculate_presidential_effect(df, trend)
    ...
    perform_statistical_decomposition(df, images_dir)
    # Forecast
